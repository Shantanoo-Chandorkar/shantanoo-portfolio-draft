          ...
          {experiences.map((exp, index) => {
            ...
            return (
              <motion.div
                ...
                style={{ width: '50%' }}
              >
                <div className="absolute left-1/2 transform -translate-x-1/2 w-6 h-6 bg-primary rounded-full border-4 border-background shadow-lg z-10 -top-3" style={{ left: isLeft ? 'calc(100% + 0px)' : '0px' }} />
