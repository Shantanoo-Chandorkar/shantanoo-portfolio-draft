...
/**
 * Shared contact form panel used by both Classic and Contact views.
 * Includes the contact form, contact information, and social links.
 */
export function ContactFormPanel({ delay = 0.2 }: ContactFormPanelProps) {
