...
const options: {
...
}[] = [
	{
		...
		icon: Leaf,
		description:
			'A clean, scrollable portfolio with smooth animations and a nature-inspired aesthetic.',
	},
	{
		mode: 'cinematic',
		title: 'Cinematic',
		...
		icon: Sparkles,
		description:
			'A dramatic full-screen hero, sticky navigation, impact stats, and engaging interactions.',
	},
];
