...
export const contactSocialLinks = [
  { icon: Github, label: 'GitHub', href: 'https://github.com/Shantanoo-Chandorkar', color: 'hover:text-gray-400' },
  { icon: Linkedin, label: 'LinkedIn', href: 'https://linkedin.com/in/shantanoo-chandorkar', color: 'hover:text-blue-400' },
];
